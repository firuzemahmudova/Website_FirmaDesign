...
document.querySelectorAll('a').forEach(link => {
    link.addEventListener('click', function(e) {
        if (this.hostname === window.location.hostname && !this.getAttribute('href').startsWith('#')) {
            ...
            // Əgər overlay varsa animasiyanı işlət, yoxdursa birbaşa keç
            if (overlay) {
                e.preventDefault(); // Yalnız overlay varsa blokla
                overlay.classList.remove('from-left', 'from-right');
                overlay.classList.add('from-left');
                ...
                // Overlay yoxdursa heç nəyi bloklama, standart keçid et
                window.location = href;
            }
        }
    });
...
document.addEventListener("DOMContentLoaded", function() {
    // Düyməni və menyunu tap
    const burger = document.querySelector('.mobile-menu');
    const nav = document.querySelector('.mobile-nav');

    // Əgər hər ikisi mövcuddursa, işə sal
    if (burger && nav) {
        burger.addEventListener('click', function(e) {
            e.stopPropagation(); // Digər kliklərlə qarışmasın
            
            // Menyunun vəziyyətini yoxla
        ...
        // Menyudan kənara klikləyəndə bağlansın (Opsional)
        ...
        console.warn("Burger və ya Nav tapılmadı. HTML-də klass adlarını yoxla!");
    }
});